...
public class PossibiliteDeZoneService {
    ...
    public void saveExcelData(PossibiliteDeZoneRepository possibiliteDeZoneRepository2, InputStream inputStream) throws IOException {
    ...
    return inputStream;
        ...
        public void savePdfData(PossibiliteDeZoneRepository possibiliteDeZoneRepository, InputStream inputStream) throws IOException {
     Set<PossibiliteDeZone> possibiliteDeZones = new HashSet<PossibiliteDeZone>();
            ...
            for (PdfTable table : tableLists) {
                ...
                for (int i = 1; i < table.getRowCount(); i++) {
                    ...
                    int j = 0;
                        ...
                        possibiliteDeZone.setSpecification(table.getText(i, j));
                        possibiliteDeZone.setPossibiliteEmploi(table.getText(i, j+1));
                        possibiliteDeZone.setAxeStrategique(table.getText(i, j+2));
