    ...
    public void saveExcelData(PaysRepository paysRepository, InputStream inputStream) throws IOException {
        ...
        try {
            ...
            workbook.getSheetAt(0).forEach(row -> {
               ...
               pays1.setAccessible(row.getCell(2).getStringCellValue());
               pays1.setDensite(row.getCell(3).getStringCellValue());
               pays1.setSuperficie((int) row.getCell(4).getNumericCellValue());
               pays1.setDateIndependance(row.getCell(5).getStringCellValue());
               pays1.setDateReunification(row.getCell(6).getStringCellValue());
               pays1.setDateUnification(row.getCell(7).getStringCellValue());
