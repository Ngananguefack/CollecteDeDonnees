...
public class MInfrastructureService {
    ...
    return inputStream;
        ...
        public void savePdfData(MInfrastructureRepository mInfrastructureRepository, InputStream inputStream) throws IOException {
     Set<MInfrastructure> mInfrastructures = new HashSet<MInfrastructure>();
            ...
            for (PdfTable table : tableLists) {
                ...
                for (int i =1; i < table.getRowCount(); i++) {
                    ...
                    int j = 0;
                        ...
                        mInfrastructure.setMInfrastructure(table.getText(i, j));
